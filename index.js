    ...
    res.send(`  
        <html>  
            <body style="text-align: center; padding-top: 50px; font-family: Arial, sans-serif;">  
                ...
                <p style="position: fixed; bottom: 10px; width: 100%; text-align: center; font-size: 0.8em;">  
                    <a href="https://github.com/KevinWang15/fucfuclaude" target="_blank" style="color: #888; text-decoration: none;">  
                        <span style="text-decoration: underline">https://github.com/KevinWang15/fucfuclaude</span> 法克法克劳德，啥也不是。 Made with Claude  
                    </a>  
                </p>  
            </body>  
        </html>  
